...
# FIX We want to build magento with PHP 7.4
FROM php:8.1-apache

LABEL company="Bevy"
LABEL maintainer="technology@bevy-express.com"
...
RUN apt-get update && apt-get install -y \
    ...
    # FIX: ALREADY AVAILABLE IN PHP 8
...
ENV MYSQL_HOSTNAME="mysql" MYSQL_USERNAME="root" MYSQL_PASSWORD="" MYSQL_DATABASE="magento" CRYPT_KEY="" \
